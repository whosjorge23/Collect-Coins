...
//        ground?.physicsBody?.collisionBitMask = coinManCategory
    ...
    func createCoin() {
        ...
        let coin = SKSpriteNode(imageNamed: "\(randomDiamond)")
    ...
    func createBomb() {
        ...
        let bomb = SKSpriteNode(imageNamed: "\(randomEnemy)")
        ...
        let moveLeft = SKAction.moveBy(x: -size.width - bomb.size.width, y: 0, duration: TimeInterval(fast))
